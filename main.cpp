...
bool Logged(T &Acc)
{
    ...
    menuList.push_back("2. Services");
    menuList.push_back("3. Customer & Invoices");
    menuList.push_back("4. Account settings");
    if (Acc.isManager())
        menuList.push_back("5. Account Management");
...
void PrintMain()
{
    ...
    std::cout << "> MAIN MENU <";
    gotoXY(48, 26);
    std::cout << "Press the number key corresponding to the menu items to access.";
    setColor(7);
    gotoXY(70, 18);
    std::cout << "1. Login as Employee";
    gotoXY(70, 19);
    std::cout << "2. Sign-in";
    gotoXY(70, 20);
